...
hoistedDependencies:
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.8.3)(ts-node@10.9.1):
    jest-cli: private
  /jest-config/29.7.0(@types/node@20.8.3)(ts-node@10.9.1):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 09 Oct 2023 08:04:08 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/hshahir/Library/pnpm/store/v3
